...
namespace zlgui::slider {
    ...
    public:
        ...
        void setNameLayout(const float font_scale, const int maximum_lines) {
            label_look_and_feel_.setFontScale(font_scale);
            label_look_and_feel_.setMaximumNumberOfLines(maximum_lines);
            label_.repaint();
        }
