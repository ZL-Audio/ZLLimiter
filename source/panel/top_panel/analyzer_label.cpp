...
namespace zlpanel {
    ...
    void AnalyzerLabel::mouseDown(const juce::MouseEvent&) {
        const auto f = static_cast<double>(base_.getPanelProperty(zlgui::PanelSettingIdx::kAnalyzerSettingPanel));
        base_.setPanelProperty(zlgui::PanelSettingIdx::kAnalyzerSettingPanel, f < .5 ? 1. : 0.);
    }
