...
# ZL Limiter
![pluginval](<https://github.com/ZL-Audio/ZLLimiter/actions/workflows/cmake_full_test.yml/badge.svg?branch=main>)
...
```console
git clone https://github.com/ZL-Audio/ZLLimiter
cd ZLLimiter
